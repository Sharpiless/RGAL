...
class UnlabeledImageDataset(torch.utils.data.Dataset):
    def __init__(self, root, transform=None, pair_sample=False):
...
class ImagePool(object):
    ...
    def get_dataset(self, transform=None, pair_sample=False):
        return UnlabeledImageDataset(self.root, transform=transform, pair_sample=pair_sample)
